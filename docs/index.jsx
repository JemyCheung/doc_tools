...
banner:
  name: '更懂你的七牛文档站'
  desc: '基于 markdown 的静态站点'
  btns:
    - { name: '开 始', href: './android/android.html', primary: true }
    - { name: 'Github >', href: 'https://github.com/JemyCheung/doc_tools' }
  caption: '当前版本: v1.0.0'
features:
  - { name: '优雅', desc: '经过精雕细琢，我们带给大家一个精心设计的、拥有卓越的视觉与交互体验的文档' }
